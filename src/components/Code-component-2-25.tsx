    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <AnimatedCounter end={5} label="Years of Experience" delay={0.2} />
          <AnimatedCounter end={150} label="Projects Completed" delay={0.4} />
          <AnimatedCounter end={98} label="Happy Clients" delay={0.6} />
        </div>
