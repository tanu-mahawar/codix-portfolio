...
const achievements = [
  ...
  },
  {
    ...
    description: "Successfully launched websites across industries",
    percentage: 80
  },
  {
    icon: Globe,
    title: "100% Client Satisfaction",
    description: "Focused on quality, results, and long-term growth",
    percentage: 95
  }
];
